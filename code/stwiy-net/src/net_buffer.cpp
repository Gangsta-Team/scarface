...
void gangsta::sf_net::Buffer::write_data(void *p_src, size_t p_length) {
    if (p_length <= 0) {
        return;
    }
...
void gangsta::sf_net::Buffer::write_string(const std::string &p_val) {
...
std::string gangsta::sf_net::Buffer::read_string() {
    std::vector<char> buf;
...
uint8_t gangsta::sf_net::Buffer::read_u8() {
    if (position >= virtual_length) {
        // end of file
        return 0;
    }
...
uint16_t gangsta::sf_net::Buffer::read_u16() {
    uint16_t value = (uint16_t) (read_u8() | read_u8() << 8);
    return value;
}

uint32_t gangsta::sf_net::Buffer::read_u32() {
    uint32_t value = (uint32_t) (read_u8() | (read_u8() << 8) | (read_u8() << 16) | (read_u8() << 24));
    return value;
}

void gangsta::sf_net::Buffer::write_u8(uint8_t p_val) {
    int val_length = 1;
...
void gangsta::sf_net::Buffer::write_u32(uint32_t p_val) {
    write_u8(p_val);
    write_u8(p_val << 8);
    write_u8(p_val << 16);
    write_u8(p_val << 24);
...
void gangsta::sf_net::Buffer::read_data(void *p_dst, size_t p_length) {
    if (p_dst == nullptr) {
        return;
    }
...
void
gangsta::sf_net::Buffer::get_data(size_t p_src_offset, size_t p_src_count, void *p_dst, size_t p_dst_length) const {
    if (p_dst == nullptr) {
        return;
    }
...
void gangsta::sf_net::Buffer::get_all_data(void *p_dst, size_t p_dst_length) const {
    if (p_dst_length <= 0) {
        return;
    }
...
void gangsta::sf_net::Buffer::seek(size_t p_position) {
...
size_t gangsta::sf_net::Buffer::get_position() const {
    return position;
}

size_t gangsta::sf_net::Buffer::get_length() const {
    return virtual_length;
}

void gangsta::sf_net::Buffer::set_length(size_t p_length) {
...
size_t gangsta::sf_net::Buffer::get_available() const {
    return virtual_length - position;
}

gangsta::sf_net::Buffer *gangsta::sf_net::Buffer::slice(size_t p_length) {
    Buffer *buffer = new Buffer(&data[position], p_length);
    return buffer;
}

void gangsta::sf_net::Buffer::grow(size_t p_length) {
...
gangsta::sf_net::Buffer::Buffer(void *p_data, size_t p_length) {
...
uint8_t *gangsta::sf_net::Buffer::get_ptr() {
    return data;
}
